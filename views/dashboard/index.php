...
<body>
    ...
    <main>
        <div class="sidebar">
            ...
            <a href="" class="active"><i class="fa fa-dashboard mr-1"></i><span class="hidden">Home</span></a>
                    ...
                    <div class="col-md-3 mt-3">
                        <div id="dash-card" class="shadow">
                            <div class="d-flex justify-content-between">
                                <h6>Orders</h6>
                                <i class="fa fa-first-order mr-1 dash-icon-circle fa-2x "></i>
                            </div>
                            <div class="badge badge-danger" id="ordercount">
                            </div>
                        </div>
                    </div>
                    <!--card 1-->
                    ...
                    <div class="col-md-3 mt-3">
                        <div id="dash-card" class="shadow">
                            <div class="d-flex justify-content-between">
                                ...
                                <i class="fa fa-truck fa-2x mr-1 dash-icon-circle"></i>
                            </div>
                            <div class="badge badge-info">
                                <h6> <strong>231</strong> </h6>
                            </div>
                        </div>
                    </div>
                    <!--card 4-->
                ...
                <div class="row pl-2">
                    ...
                    <div class="col-md-9 mt-4">
                        <div class="shadow uploads" style="overflow-y: auto;">
                            <div class="d-flex justify-content-between">
                                <h6>
                                    <strong>Recently Uploaded Products</strong>
                                </h6>
                            ...
                            <div class="table-responsive" style="overflow: auto;">
                                <table class="table table-bordered table-striped" width='100%'>
                                    ...
                                    <tbody id="miniproductbody">


                                    </tbody>
                                </table>
                                <small><a href="./managePosts.php" class="text-muted">View All <i
                    ...
                    <div class="col-md-3 mt-4">
                        <div class="shadow uploads" style="overflow-y: auto;">
                            <div class="d-flex justify-content-between">
                                ...
                                <i class="fa fa-first-order mr-1 dash-icon-circle"></i>
                            </div>
                            <hr>
                            <div class="" style="overflow: auto;">
                                <table class="table table-bordered table-striped" width='100%'>
                                    <thead>
                                        ...
                                        <th><small>full address</small></th>
                                        <th><small>email</small></th>
                                        <th><small>createdAt</small></th>
                                    </thead>
                                    <tbody id="minordertable">

                                    </tbody>
                                </table>
                            </div>
                            <small><a href="./orders.html" class="text-muted">View All <i class="fa fa-arrow-right"></i>
                                </a></small>
                        </div>
                    </div>
                </div>
