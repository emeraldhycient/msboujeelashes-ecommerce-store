...
<body>
                ...
                <div class="row pl-4 pr-4">
                    <div class="col-md-10 m-auto shadow p-2" style="background-color: #fafafa;">
                        <form class="form-group" method="POST" id="addproduct" enctype="multipart/form-data">
                            ...
                            <label>Name:</label>
                            <input type="" class="form-control mb-2" id="name" name="name" required>
                            <label>Price:</label>
                            <input type="number" class="form-control mb-2" id="price" name="price" required>
                            <label>Qty:</label>
                            <input type="number" class="form-control mb-2" id="qty" name="qty" required>
                            <input type="hidden" id="id" name="id" required>
                            <label>category:</label>
                            <select name="category" name="category" id="catgory"
                            ...
                            <textarea id="editor1" name="editor1" rows="10" cols="80" class="form-control" required>
                            </textarea>
    ...
    <script src="../../assets/javascript/editProduct.js"></script>
